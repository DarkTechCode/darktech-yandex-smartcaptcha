...
require_once DARKTECH_YSC_PLUGIN_DIR . 'includes/trait-darktech-ysc-admin.php';
require_once DARKTECH_YSC_PLUGIN_DIR . 'includes/trait-darktech-ysc-rendering.php';
require_once DARKTECH_YSC_PLUGIN_DIR . 'includes/trait-darktech-ysc-validation.php';
require_once DARKTECH_YSC_PLUGIN_DIR . 'includes/class-darktech-yandex-smartcaptcha.php';

new DarkTech_Yandex_SmartCaptcha();
